...
import { 
  Home, Book, Music, Mic, Heart, BookOpen, Menu, X, LayoutGrid, TrendingUp, Sparkles, BookMarked, Play, Pause, List, RefreshCw, ChevronUp, ChevronDown, Shield, FileText, HelpCircle, Mail
} from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const translations: any = {
    en: {
      ...
      searchWords: "Search words in ayah...",
      tafsir: "Tafsir",
      back: "Back",
      retry: "Retry",
      settings: "Settings",
      hijaiyah: "Hijaiyah Letters",
      study: "Study",
      practice: "Practice",
      quiz: "Quiz",
      bookmarks: "Bookmarks",
    ...
    id: {
      ...
      searchWords: "Cari kata dalam ayat...",
      tafsir: "Tafsir",
      back: "Kembali",
      retry: "Coba Lagi",
      settings: "Pengaturan",
  ...
  const legalItems = [
    ...
    { name: t.terms, icon: <FileText size={22} />, path: '/privacy' }, 
  ...
  return (
    <Router>
      ...
      >
        ...
        {/* Mobile Header per Instruction #1 */}
        {!isReadingMode && (
          <header className="md:hidden flex items-center p-5 bg-emerald-800 text-white sticky top-0 z-50 app-header shadow-2xl gap-4">
          ...
          `}>
            <div className="flex flex-col h-full">
              ...
              <nav className="flex-1 px-6 py-6 space-y-1 overflow-y-auto">
                ...
                {/* Contact Us moved to Sidebar bottom per Instruction #7 */}
                <div className="pt-4 mt-4 border-t border-emerald-800/40">
                  ...
                  >
                    ...
                    <span className="font-black text-base">{t.contact}</span>
                  </a>
                </div>
              </nav>
